package com.neil.musicspace.utils.http;
...
public class OkHttpUtil {
     ...
     * @return
     */
    public void getDataAsync(String url, final NetCall netCall) throws Exception {
        //1 构造Request
        Request.Builder builder = new Request.Builder();
        Request request = builder.get().url(url).build();
        //2 将Request封装为Call
     ...
     * @param netCall
     */
    public void postDataAsync(String url, Map<String, String> bodyParams, final NetCall netCall) throws Exception {
        //1构造RequestBody
        RequestBody body = setRequestBody(bodyParams);
        //2 构造Request
        Request.Builder requestBuilder = new Request.Builder();
    ...
    public void postJsonAsync(String url, String json, final NetCall netCall) throws Exception {
        RequestBody body = RequestBody.create(json,JSON);
        //2 构造Request
        Request.Builder requestBuilder = new Request.Builder();
        Request request = requestBuilder.post(body).url(url).build();
